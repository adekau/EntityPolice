	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		if (commandLabel.equalsIgnoreCase("entitypolice")
			...
			if(!(sender instanceof Player)) {
				sender.sendMessage("This can only be performed in game.");
				return false;
			}else{
			...
			if (subCommand.equalsIgnoreCase("count")) {
				if (player.hasPermission("entitypolice.count") && (sender instanceof Player)) {
				...
				if (player.hasPermission("entitypolice.remove") && (sender instanceof Player)) {
				...
				if (player.hasPermission("entitypolice.countnear") && (sender instanceof Player)) {
					if(args.length == 4) {
				...
				if (player.hasPermission("entitypolice.removenear") && (sender instanceof Player)) {
					if(args.length == 4) {
			...
			} else if (subCommand.equalsIgnoreCase("help") && (sender instanceof Player)) {
